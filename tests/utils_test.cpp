...
TEST(UtilsTest, DeleteHttpHeader) {
  std::string payload = "GET / HTTP/1.1\r\nUser-Agent: "
                        "Cpp\r\nContent-Length: 5\r\n\r\nhello";
  std::string new_payload =
...
TEST(UtilsTest, DecompressGZipBody) {
  std::string expected =
