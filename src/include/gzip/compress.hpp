...
public:
  Compressor(
      ...
      std::size_t max_bytes = 2000000000) // by default refuse operation if
                                          // uncompressed data is > 2GB
...
#pragma GCC diagnostic pop
    ...
    do {
      ...
      // wrong here." Basically only possible error is from deflateInit not
      // working properly
